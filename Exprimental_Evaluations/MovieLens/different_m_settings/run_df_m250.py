...
def bg_optimise_cbf(M, n, alpha, persDiv, candidate_items_dict):
    ...
    with open('results/m_250/CBF/bg_alpha'+str(alpha)+'_persDiv_'+str(persDiv)+'.csv', mode='w') as file:
...
with open('results/m_250/CBF/accuracy_cbf.csv', 'w') as accu_cbf:
...
def bg_optimise_top_pop(M, n, alpha, persDiv, candidate_items_dict):
    ...
    with open('results/m_250/TopPopular/bg_alpha'+str(alpha)+'_persDiv_'+str(persDiv)+'.csv', mode='w') as file:
        file.write('ild_profil,ild_rec\n')
...
with open('results/m_250/TopPopular/accuracy_top_pop.csv', 'w') as accu_top_pop:
...
def bg_optimise_cbf_pop(M, n, alpha, persDiv, candidate_items_dict):
    ...
    with open('results/m_250/CBF_TopPopular/bg_alpha'+str(alpha)+'_persDiv_'+str(persDiv)+'.csv', mode='w') as file:
        file.write('ild_profil,ild_rec\n')
...
with open('results/m_250/CBF_TopPopular/accuracy_cbf_pop.csv', 'w') as accu_cbf_pop:
...
def bg_optimise_ibcf(M, n, alpha, persDiv, candidate_items_dict):
    ...
    with open('results/m_250/IBCF/bg_alpha'+str(alpha)+'_persDiv_'+str(persDiv)+'.csv', mode='w') as file:
        file.write('ild_profil,ild_rec\n')
...
with open('results/m_250/IBCF/accuracy_ibcf.csv', 'w') as accu_ibcf:
...
def bg_optimise_svd(M, n, alpha, persDiv, candidate_items_dict):
    ...
    with open('results/m_250/SVD/bg_alpha'+str(alpha)+'_persDiv_'+str(persDiv)+'.csv', mode='w') as file:
        file.write('ild_profil,ild_rec\n')
...
with open('results/m_250/SVD/accuracy_svd.csv', 'w') as accu_svd:
...
def bg_optimise_dnn(M, n, alpha, persDiv, candidate_items_dict):
    ...
    with open('results/m_250/DNN/bg_alpha'+str(alpha)+'_persDiv_'+str(persDiv)+'.csv', mode='w') as file:
        file.write('ild_profil,ild_rec\n')
...
with open('results/m_250/DNN/accuracy_dnn.csv', 'w') as accu_dnn:
...
def bg_optimise_kge(M, n, alpha, persDiv, candidate_items_dict):
    ...
    with open('results/m_250/KGE/bg_alpha'+str(alpha)+'_persDiv_'+str(persDiv)+'.csv', mode='w') as file:
        file.write('ild_profil,ild_rec\n')
...
with open('results/m_250/KGE/accuracy_kge.csv', 'w') as accu_kge:
